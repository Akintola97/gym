...
const expectations = () => {
    ...
    <div className='h-full w-full bg-gray-200'>
        ...
        <div className='w-full h-full text-center flex md:flex-row flex-col pt-3'>
          <div className='md:p-5'>  
            <h3 className='font-bold text-[2.5vmin] uppercase'>Barbells</h3>
      ...
      <div className='md:p-5'>
      <h3 className='font-bold text-[2.5vmin] uppercase'>Combo Racks</h3>
        ...
        <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>MonoLifts</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Video Recording</h3>
 ...
 <div className='w-full h-full text-center flex md:flex-row flex-col'>
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase '>SPOTTING AND LOADING</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Community</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Competitions</h3>
       ...
       <div className='w-full h-full text-center flex md:flex-row flex-col'>
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>KILO PLATES</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Sharing Equipment</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Chalk and baby powder</h3>
       ...
       <div className='md:p-5'>
       <h3 className='font-bold text-[2.5vmin] uppercase'>Ego Lifting</h3>
        ...
        <div className='w-full h-full text-center pt-3 flex md:flex-row flex-col'>
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Concrete Stones</h3>
        <p className='text-[2.0vmin]'>Concrete stones should only be used in the designated pit. This is the only area where tacky is allowed. Please do not get tacky anywhere else outside of this area.</p>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Stones of Steel</h3>
       <p className='text-[2.0vmin] '>Stones of steel should only be used with sticky spray if you need additional grip. You can use the designated platforms or Yoke to throw them over the bar as needed.</p>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Sandbags</h3>
        <p className='text-[2.0vmin] '>Sandbags should always be returned and properly organize since they can be some of the most difficult to move around. If any of them break please help sweep up and let us know!</p>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] pb-2 uppercase'>Silencer Pads</h3>
        <p className='text-[2.0vmin] '>There are red silencer pads available and should be used when dropping equipment from a height to keep them from breaking such as logs, stones of steel, kegs, etc. </p>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] pb-2 uppercase'>Power Keg</h3>
        <p className='text-[2.0vmin] '>The loadable power keg should always be fastened properly before use in order to ensure the welding doesn't break on the inside.</p>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Strongman Logs</h3>
      ...
      <div className='h-full w-full bg-gray-200 pb-32'>
        ...
        <div className='w-full h-full text-center pt-3 flex justify-center'>
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Boxing Ring</h3>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Class Times</h3>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Sparring</h3>
          ...
          <div className='md:p-5'>
        <h3 className='font-bold text-[2.5vmin] uppercase'>Boxing Gear</h3>
