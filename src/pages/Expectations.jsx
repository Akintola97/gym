    ...
    <div className='h-full w-full bg-gray-100'>
      ...
      <h3 className='font-bold text-[2.7vmin] pb-2'>Combo Racks</h3>
       ...
       <h3 className='font-bold text-[2.7vmin] pb-2'>Ego Lifting</h3>
          ...
          <h3 className='font-bold text-[2.7vmin] pl-3'>Equipment Clean Up</h3>
          <ul>
            <li><p className='text-[2.3vmin]'>Always return equipment. We do not have staff to clean up after our members<br></br> If anything breaks also please let us know. We won't be mad at you and would rather fix the issue!</p></li>
          </ul>
        </div>
        </div>
        <div className='h-full w-full bg-gray-100'>
        ...
        <h3 className='font-bold text-[2.5vmin] pl-2 text-left'>Equipment Maintence</h3>
        <ul>
            <li><p className='text-[2.3vmin] text-left'> This is one of the areas that sees the most damage. <br></br>Please help us take care of the equipment and if anything breaks please let us know!</p></li>
          </ul>
      </div>
      </div>
      <div className='h-full w-full bg-gray-100'>
        ...
        <h3 className='font-bold text-[2.7vmin] pb-2'>Boxing Gear</h3>
          ...
          <h3 className='font-bold text-[2.7vmin] pl-2 text-left'>Important Note:</h3>
          <ul>
            <li><p className='text-[2.3vmin] text-left pb-10'>Boxing should never be used as an outlet to hurt someone else. <br></br> In the gym we are here to train and help each other. <br></br> If you wish to compete we can set that up for you!</p></li>
          </ul>
        </div>
        </div>
    </>
