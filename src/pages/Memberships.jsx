...
const Memberships = () => {
  return (
    ...
    <div className='h-full w-full bg-gray-200 text-black pb-10'>
      <h1 className='font-bold pt-5 text-center text-[5vmin] md:text-[6vmin] '>FAQ's</h1>
      <div className='h-full w-full text-center flex flex-col p-4'>
       ...
       <div><h6 className='font-bold pt-3'>I've never been to a private powerlifting gym, what should I know? </h6><span>Our biggest values are respect, humility, and giving back! Please don't be afraid to ask for help and our members are more than willing you out. We also highly recommend visiting the gym expectations page for a quick run down on general etiquette at the gym!
        </span>
        </div>  
       
       <div><h6 className='font-bold pt-3'>How do I gain 24/7 access?</h6><span>All memberships include 24/7 access via a key card you will receive once you have signed up! 
        </span>
        </div>  
       
       <div><h6 className='font-bold pt-3'>Is SURGE open year-round?</h6><span>SURGE is open all year-round! The only time we close are to host events and competitions which we will always post here on the website or on our social media!
        </span>
       </div>
       <div>
